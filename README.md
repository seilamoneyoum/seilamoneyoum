...
**🛸 Metal Mind** (Projet de synthèse – Cégep de Sainte-Foy, Janv. - Mars 2024)  
Jeu de stratégie 3D tour-par-tour avec **Unity (C#)**.  
- Conception du gameplay (grille, sélection/combat des unités), correction de bugs et optimisation.  
- Collaboration agile (Git, revues de code, merge requests).  
🔗 [Voir le dépôt GitLab](https://gitlab.com/DamienLeblond/AlienKiller)

**📱 Selfsight** (Projet personnel – Janv. 2026 - présent)  
App mobile full-stack de gestion d'objectifs personnels avec **Flutter**.  
- Opérations CRUD pour tâches, objectifs et tableaux de vision.  
- Persistance des données en temps réel et interface utilisateur adaptative.  
🔗 [Voir le dépôt GitHub](https://github.com/seilamoneyoum/selfsight)
...
![VB](https://img.shields.io/badge/-Visual%20Basic-5E2B97?style=flat&logo=.net&logoColor=white)
